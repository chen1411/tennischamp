...
class BndBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    double _calAngle(Map<String, dynamic> pts){
      ...
      num seDist2 = pow(shoulderX-elbowX, 2) + pow(shoulderY-elbowY, 2);
      num ewDist2 = pow(wristX-elbowX, 2) + pow(wristY-elbowY, 2);
      num swDist2 = pow(shoulderX-wristX, 2) + pow(shoulderY-wristY, 2);
